...
//    public static final int WRAITHS = 6;
    ...
    public List<Formation> availableFormations(int unit) {
        switch (unit) {
            case RAVOS_THE_EVERHUNGRY: return new AlianaOfSummersong().availableFormations();
            case UTHUK_BERSERKERS: return new DeepwoodArchers().availableFormations();
            case FLESH_RIPPERS: return new LeonxRiders().availableFormations();
            case SPINE_THRESHERS: return new AymhelinScions().availableFormations();
